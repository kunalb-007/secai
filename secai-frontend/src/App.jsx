      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* Questionnaires — upload before :id to avoid route collision */}
            <Route path="/questionnaires/upload" element={<PrivateRoute><QuestionnaireUploadPage /></PrivateRoute>} />
            <Route path="/questionnaires/:id"    element={<PrivateRoute><QuestionnaireDetailPage /></PrivateRoute>} />
            <Route path="/questionnaires"        element={<PrivateRoute><QuestionnaireListPage /></PrivateRoute>} />
